...
namespace Selzy\ApiWrapper;

/**
 * API Selzy.
 *
 * @link https://selzy.com/en/support/category/api/
 * @link https://selzy.com/ua/support/category/api/
 *
 ...
 * UniOne — the transactional letter service from Selzy. https://www.selzy.com/en/features/unione/
 ...
 * both through the Selzy personal account and through the API.
 * @method string listTemplates(array $params = []) This method is used to get the list of templates created both
 * through the Selzy personal account and through the API.
 ...
 * the Selzy personal account and through the API. The method works like getMessages, the difference of
...
class SelzyApi
{
     ...
     *
     * $SelzyApi = new SelzyApi('api key here', 'UTF-8', 4, null, false, $platform);
     * $SelzyApi->sendSms(
    ...
    /**
     * Export of contact data from Selzy.
     ...
     *
     * @see https://www.selzy.com/en/support/api/contacts/exportcontacts/
     *
     * @param array $params
     *
     * @return false|string
     ...
     * You can also request task status.
     *
     * @see https://www.selzy.com/en/support/api/statistics/getcampaigndeliverystats/
     *
     * @param array $params
     *
     * @return false|string
     ...
     *
     * @see https://www.selzy.com/en/support/api/common/getcurrencyrates/
     *
     * @return false|string
     */
     ...
     * @param array $params
     *
     * @see https://www.selzy.com/en/support/api/messages/validatesender/
     *
     * @return false|string
     */
     ...
     *
     * @see https://www.selzy.com/en/support/api/messages/setsenderdomain/
     *
     * @param array $params
     *
     * @return false|string
     ...
     *
     * @see https://www.selzy.com/en/support/api/messages/getsenderdomainlist/
     *
     * @param array $params
     *
     * @return false|string
     ...
     *
     * @see https://www.selzy.com/en/support/api/messages/getcheckedemail/
     *
     * @param array $params
     *
     * @return false|string
